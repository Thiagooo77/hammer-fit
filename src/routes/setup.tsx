      ...
      <div className="max-w-md w-full bg-background p-8 rounded-xl shadow-lg border border-border">
        ...
        {status === "idle" && (
          <div className="text-center">
            <p className="mb-6 text-muted-foreground">Clique no botão abaixo para criar o Administrador Master inicial.</p>
            <Button onClick={handleSetup} className="w-full">Iniciar Configuração</Button>
          </div>
        )}
        ...
        {status === "success" && (
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6">Agora você pode fazer login com as credenciais padrão.</p>
        ...
        {status === "error" && (
          <div className="text-center">
            ...
            <p className="font-bold text-destructive mb-2">Erro na Configuração</p>
